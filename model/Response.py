...
class Response(object):
    def __init__(self, id=None, replyHost=None, replyPort=None, replyChannel=None, versionProtocol=None, statusCode=None, statusMessage=None, header=None, body=None):
        self.id = id
